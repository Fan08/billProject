...
public interface BillMapper extends BaseMapper<Bill> {
  // 自定义 sql 语句
  @Select("select single_bill.*, bill_type.nature, bill_type.name, bill_type.icon from single_bill left join bill_type on bill_type.uuid=single_bill.type ${ew.customSqlSegment}")
